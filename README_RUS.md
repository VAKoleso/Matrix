...
0. [Введение](#введение) \
1. [Реализация функций библиотеки matrix.h](#реализация-функций-библиотеки-matrix.h) \
2. [Информация](#информация) \
3. [Структура матрицы на языке C](#структура-матрицы-на-языке-C:)
...
- Матрица реализована в виде структуры описанной [здесь](#структура-матрицы-на-языке-c) 
...
Поле matrix_type инициализируется значением ZERO_MATRIX.
...
Если невозможно вычислить определитель переданной матрицы, функция вернет значение NAN.
